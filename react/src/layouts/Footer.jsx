...
const Header = () => {
    ...
    return (
        <div className="flex justify-around items-center p-4 bg-transparent">
            ...
            <div style={{borderColor: color}} className="border-4  bg-neutral-300 rounded-2xl h-28 py-3 text-2xl font-serif text-white font-bold">
                <ColorSelect />
            </div>

            <form style={{borderColor: color}} onSubmit={handleSubmit} className="border-4 p-4 h-28 flex-col gap-4 bg-neutral-300 rounded-2xl">
